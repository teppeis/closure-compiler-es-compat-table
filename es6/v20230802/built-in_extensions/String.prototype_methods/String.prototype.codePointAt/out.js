...
var $jscomp$lookupPolyfilledValue = function(b, a, c) {
  if (!c || null != b) {
    c = $jscomp.propertyToPolyfillSymbol[a];
    if (null == c) {
      return b[a];
    }
    c = b[c];
