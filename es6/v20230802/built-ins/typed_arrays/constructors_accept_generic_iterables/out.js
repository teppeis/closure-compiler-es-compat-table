...
module.exports = function() {
  ...
  for (var a = "Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < a.length; c++) {
    var b = new global[a[c]](__createIterableObject([1, 2, 3]));
    if (3 !== b.length || 1 !== b[0] || 2 !== b[1] || 3 !== b[2]) {
      return !1;
    }
  }
  return !0;
