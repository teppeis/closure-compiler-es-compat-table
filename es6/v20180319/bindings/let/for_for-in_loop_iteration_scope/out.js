...
module.exports = function() {
  ...
  var $jscomp$loop$1 = {};
  $jscomp$loop$1.i = 0;
  for (; $jscomp$loop$1.i < 2; $jscomp$loop$1 = {i:$jscomp$loop$1.i}, $jscomp$loop$1.i++) {
    scopes.push(function($jscomp$loop$1) {
      return function() {
        return $jscomp$loop$1.i;
      };
    }($jscomp$loop$1));
  }
  ...
  scopes = [];
  var $jscomp$loop$2 = {};
  for (var i$0 in{a:1, b:1}) {
    $jscomp$loop$2.i$0 = i$0;
    scopes.push(function($jscomp$loop$2) {
      return function() {
        return $jscomp$loop$2.i$0;
      };
    }($jscomp$loop$2));
    $jscomp$loop$2 = {i$0:$jscomp$loop$2.i$0};
  }
