...
$jscomp.polyfill("Reflect.set", function(a) {
  return a ? a : function(a, c, e, d) {
    var b = $jscomp.findDescriptor(a, c);
    return b ? b.set ? (b.set.call(3 < arguments.length ? d : a, e), !0) : b.writable && !Object.isFrozen(a) ? (a[c] = e, !0) : !1 : Reflect.isExtensible(a) ? (a[c] = e, !0) : !1;
  };
}, "es6", "es5");
