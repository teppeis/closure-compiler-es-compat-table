...
module.exports = function() {
  ...
  new Proxy({}, {});
  try {
    Object.keys(new Proxy({}, {ownKeys:function() {
      passed = true;
      return [2];
    }}));
    return false;
  ...
  try {
    Object.keys(new Proxy(proxied, {ownKeys:function() {
      return [];
    }}));
    return false;
  } catch (e$0) {
  ...
  try {
    Object.keys(new Proxy(Object.preventExtensions({b:1}), {ownKeys:function() {
      return ["a"];
    }}));
    return false;
  } catch (e$1) {
