...
module.exports = function() {
  ...
  new Proxy({}, {});
  var proxied = {};
  var proxy = new Proxy(proxied, {getOwnPropertyDescriptor:function() {
    passed = true;
    return undefined;
  }});
  ...
  try {
    Object.getOwnPropertyDescriptor(new Proxy(proxied, {getOwnPropertyDescriptor:function() {
  ...
  try {
    Object.getOwnPropertyDescriptor(new Proxy({}, {getOwnPropertyDescriptor:function() {
  ...
  try {
    Object.getOwnPropertyDescriptor(new Proxy({baz:1}, {getOwnPropertyDescriptor:function() {
