...
module.exports = function() {
  var a = !1;
  new Proxy({}, {});
  var b = {}, c = new Proxy(b, {getOwnPropertyDescriptor:function() {
    a = !0;
  }});
  Object.defineProperty(b, "foo", {value:2, writable:!0, enumerable:!0});
  try {
    return Object.getOwnPropertyDescriptor(c, "foo"), !1;
  } catch (e) {
  }
  b.bar = 3;
  Object.preventExtensions(b);
  try {
    return Object.getOwnPropertyDescriptor(c, "bar"), !1;
  } catch (e) {
  }
  try {
    return Object.getOwnPropertyDescriptor(new Proxy(b, {getOwnPropertyDescriptor:function() {
