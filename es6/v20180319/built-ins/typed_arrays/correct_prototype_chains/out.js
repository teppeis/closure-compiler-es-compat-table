...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.then = function(a, b) {
    ...
    var e, l, m = new d(function(a, b) {
      e = a;
      l = b;
    });
    this.callWhenSettled_(c(a, e), c(b, l));
    return m;
  };
  ...
  d.all = function(a) {
    ...
    return e.done ? c([]) : new d(function(a, d) {
      ...
      var k = [], l = 0;
      do {
        k.push(void 0), l++, c(e.value).callWhenSettled_(h(k.length - 1), d), e = b.next();
      } while (!e.done);
    });
  };
  return d;
...
module.exports = function() {
  var a = "Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), b = Object.getPrototypeOf(Int8Array), c = Object.getPrototypeOf(Int8Array.prototype);
  if (b === Function.prototype || c === Object.prototype) {
    return !1;
  }
  for (var e = 0; e < a.length; e += 1) {
    if (!(a[e] in global && Object.getPrototypeOf(global[a[e]]) === b && Object.getPrototypeOf(global[a[e]].prototype) === c && "BYTES_PER_ELEMENT,constructor" === Object.getOwnPropertyNames(global[a[e]].prototype).sort() + "")) {
      return !1;
    }
  }
  return !0;
