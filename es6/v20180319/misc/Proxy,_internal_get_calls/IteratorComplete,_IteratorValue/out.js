...
module.exports = function() {
  ...
  iterable[Symbol.iterator] = function() {
    return {next:function() {
      return new Proxy({value:2, done:false}, {get:function(o, k) {
        get.push(k);
        return o[k];
      }});
    }};
  ...
  var i = 0;
  for (var $jscomp$iter$0 = $jscomp.makeIterator(iterable), $jscomp$key$e = $jscomp$iter$0.next(); !$jscomp$key$e.done; $jscomp$key$e = $jscomp$iter$0.next()) {
