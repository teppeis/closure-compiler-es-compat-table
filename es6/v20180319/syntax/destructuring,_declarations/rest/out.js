...
module.exports = function() {
  var $jscomp$destructuring$var0 = $jscomp.makeIterator([3, 4, 5]);
  var a = $jscomp$destructuring$var0.next().value;
  var b = $jscomp.arrayFromIterator($jscomp$destructuring$var0);
  var $jscomp$destructuring$var1 = $jscomp.makeIterator([6]);
  var c = $jscomp$destructuring$var1.next().value;
  var d = $jscomp.arrayFromIterator($jscomp$destructuring$var1);
