...
module.exports = function() {
  var $jscomp$destructuring$var0 = $jscomp.makeIterator([9, {x:10}]);
  var e = $jscomp$destructuring$var0.next().value;
  var $jscomp$destructuring$var1 = $jscomp$destructuring$var0.next().value;
  var f = $jscomp$destructuring$var1.x;
  var g = $jscomp$destructuring$var1.g;
  var $jscomp$destructuring$var2 = {h:11, x:[12]};
  var h = $jscomp$destructuring$var2.h;
  var $jscomp$destructuring$var3 = $jscomp.makeIterator($jscomp$destructuring$var2.x);
  var i = $jscomp$destructuring$var3.next().value;
