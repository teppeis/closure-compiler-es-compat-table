...
module.exports = function() {
  ...
  for (var $jscomp$iter$0 = $jscomp.makeIterator(Object.create(iterable)), $jscomp$key$item = $jscomp$iter$0.next(); !$jscomp$key$item.done; $jscomp$key$item = $jscomp$iter$0.next()) {
