...
module.exports = function() {
  ...
  $jscomp.global.Object.defineProperties(C.prototype, ($jscomp$compprop0[garply] = {configurable:true, enumerable:true, get:function() {
    return "foo";
  }}, $jscomp$compprop0[grault] = {configurable:true, enumerable:true, set:function(x) {
    baz = x;
  }}, $jscomp$compprop0));
  (new C).bar = true;
