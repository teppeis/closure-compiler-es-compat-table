...
module.exports = function() {
  try {
    var $Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180319$functions$class$computed_names,_temporal_dead_zone$in$classdecl$var0 = function() {
    };
    $Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180319$functions$class$computed_names,_temporal_dead_zone$in$classdecl$var0.prototype[$Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180319$functions$class$computed_names,_temporal_dead_zone$in$classdecl$var0] = function() {
    };
    var B = $Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180319$functions$class$computed_names,_temporal_dead_zone$in$classdecl$var0;
  } catch (e) {
    return true;
  }
};
