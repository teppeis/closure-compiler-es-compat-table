...
module.exports = function() {
  ...
  C.prototype.foo;
  C.prototype.bar;
  $jscomp.global.Object.defineProperties(C.prototype, {foo:{configurable:true, enumerable:true, get:function() {
    return "foo";
  }}, bar:{configurable:true, enumerable:true, set:function(x) {
    baz = x;
  }}});
  (new C).bar = true;
