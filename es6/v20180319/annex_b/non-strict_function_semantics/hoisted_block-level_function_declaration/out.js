...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.race = function(a) {
    return new d(function(b, d) {
      for (var k = $jscomp.makeIterator(a), e = k.next(); !e.done; e = k.next()) {
  ...
  d.all = function(a) {
    ...
    return k.done ? c([]) : new d(function(a, d) {
      function e(b) {
        return function(c) {
          l[b] = c;
          m--;
      ...
      var l = [], m = 0;
      do {
        l.push(void 0), m++, c(k.value).callWhenSettled_(e(l.length - 1), d), k = b.next();
      } while (!k.done);
    });
  };
  return d;
