...
module.exports = function() {
  function a() {
    var e = this;
    return $jscomp.generator.createGenerator(a, function(f) {
      return 1 == f.nextAddress ? f.yield(e.x, 2) : f.yield(e.y, 0);
    });
  }
  var b = {g:a, x:5, y:6}.g(), c = b.next(), d = 5 === c.value && !1 === c.done;
  c = b.next();
  d &= 6 === c.value && !1 === c.done;
  c = b.next();
  return d &= void 0 === c.value && !0 === c.done;
};
