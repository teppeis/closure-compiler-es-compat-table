...
$jscomp.polyfillIsolated = function(b, e, f, h) {
  ...
  e = e(f);
  null != e && (b ? $jscomp.defineProperty($jscomp.polyfills, c, {configurable:!0, writable:!0, value:e}) : e !== f && (void 0 === $jscomp.propertyToPolyfillSymbol[c] && ($jscomp.propertyToPolyfillSymbol[c] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(c) : $jscomp.POLYFILL_PREFIX + c), $jscomp.defineProperty(h, $jscomp.propertyToPolyfillSymbol[c], {configurable:!0, writable:!0, value:e})));
};
