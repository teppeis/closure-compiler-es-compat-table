...
module.exports = function() {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  var a = (new Map)[Symbol.iterator](), b = Object.getPrototypeOf(a), e = Object.getPrototypeOf(b);
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  return e.hasOwnProperty(Symbol.iterator) && !b.hasOwnProperty(Symbol.iterator) && !a.hasOwnProperty(Symbol.iterator) && a[Symbol.iterator]() === a;
};
