...
module.exports = function(a) {
  ...
  var c = Reflect.construct(Promise, [function(a, b) {
    a("foo");
  }], b), g = Reflect.construct(Promise, [function(a, b) {
    b("quux");
  }], b), h = +(c instanceof b && g instanceof b);
  c.then = g.then = Promise.prototype.then;
  c.catch = g.catch = Promise.prototype.catch;
  c.then(function(b) {
    h += "foo" === b;
    4 === h && a();
  }, e);
