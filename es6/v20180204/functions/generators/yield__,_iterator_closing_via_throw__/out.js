...
$jscomp.polyfill("Promise", function(a) {
  ...
  c.all = function(a) {
    ...
    return f.done ? d([]) : new c(function(a, c) {
      ...
      var k = [], m = 0;
      do {
        k.push(void 0), m++, d(f.value).callWhenSettled_(e(k.length - 1), c), f = b.next();
      } while (!f.done);
    });
  };
  return c;
...
$jscomp.polyfill("WeakMap", function(a) {
  function b() {
    ...
    try {
      var b = Object.seal({}), f = Object.seal({}), d = new a([[b, 2], [f, 3]]);
      if (2 != d.get(b) || 3 != d.get(f)) {
        return !1;
      }
      d.delete(b);
      d.set(f, 4);
      return !d.has(b) && 4 == d.get(f);
    } catch (m) {
      return !1;
    }
  }
