...
$jscomp.polyfill("Map", function(a) {
  ...
  var c = function(a, b) {
    var c = b && typeof b;
    "object" == c || "function" == c ? d.has(b) ? c = d.get(b) : (c = "" + ++n, d.set(b, c)) : c = "p_" + b;
    var e = a.data_[c];
...
module.exports = function() {
  ...
  var a = "", b = __createIterableObject([1, 2, 3], {"return":function() {
    ...
    var c = 0, g, h, n, f, k, m = {next:function(a) {
