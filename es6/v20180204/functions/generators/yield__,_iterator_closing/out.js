...
module.exports = function() {
  $jscomp.initSymbolIterator();
  var closed = "";
  var iter = __createIterableObject([1, 2, 3], {"return":function() {
    closed += "a";
    return {done:true};
  }});
  var gen = function generator() {
    var $jscomp$generator$state = 0;
    var $jscomp$generator$global$errortemp;
    ...
    function $jscomp$generator$impl($jscomp$generator$action$arg, $jscomp$generator$next$arg, $jscomp$generator$throw$arg) {
      while (1) {
        switch($jscomp$generator$state) {
          case 0:
            try {
              $jscomp$generator$yield$all = $jscomp.makeIterator(iter);
            } catch ($jscomp$generator$$jscomp$generator$global$errortemp) {
              $jscomp$generator$global$error = $jscomp$generator$$jscomp$generator$global$errortemp;
              $jscomp$generator$state = 1;
              break;
            }
          case 5:
            try {
              if (!!($jscomp$generator$yield$entry = $jscomp$generator$yield$all.next($jscomp$generator$next$arg)).done) {
          ...
          case 1:
            $jscomp$generator$global$errortemp = $jscomp$generator$global$error;
            $jscomp$generator$state = -1;
            throw $jscomp$generator$global$errortemp;
            $jscomp$generator$finally0 = 3;
          case 2:
            closed += "b";
