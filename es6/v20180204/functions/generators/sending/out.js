...
module.exports = function() {
  ...
  function generator() {
    ...
    var $jscomp$generator$next$arg1;
    function $jscomp$generator$impl($jscomp$generator$action$arg, $jscomp$generator$next$arg, $jscomp$generator$throw$arg) {
      while (1) {
        switch($jscomp$generator$state) {
          ...
          case 2:
            $jscomp$generator$next$arg1 = $jscomp$generator$next$arg;
            JSCompiler_temp_const$jscomp$0 = $jscomp$generator$next$arg1;
          ...
          case 4:
            ...
            sent = [JSCompiler_temp_const$jscomp$0, $jscomp$generator$next$arg2];
            $jscomp$generator$state = -1;
          default:
