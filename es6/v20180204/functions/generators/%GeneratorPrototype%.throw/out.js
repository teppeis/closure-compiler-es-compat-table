...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.race = function(a) {
    return new d(function(b, g) {
      for (var e = $jscomp.makeIterator(a), d = e.next(); !d.done; d = e.next()) {
        c(d.value).callWhenSettled_(b, g);
      }
    });
  };
  d.all = function(a) {
