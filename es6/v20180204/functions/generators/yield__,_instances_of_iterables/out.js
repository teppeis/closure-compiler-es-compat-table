...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.all = function(a) {
    ...
    return f.done ? c([]) : new d(function(a, d) {
      ...
      var k = [], m = 0;
      do {
        k.push(void 0), m++, c(f.value).callWhenSettled_(e(k.length - 1), d), f = b.next();
      } while (!f.done);
    });
  };
  return d;
  ...
  var a = function() {
    function a(a, d, e) {
      for (;;) {
        switch(b) {
          case 0:
            h = $jscomp.makeIterator(Object.create(__createIterableObject([5, 6, 7])));
          case 1:
            if ((c = h.next(d)).done) {
              b = 2;
              break;
