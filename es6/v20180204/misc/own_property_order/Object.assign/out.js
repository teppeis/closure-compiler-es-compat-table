  ...
  d.race = function(a) {
    return new d(function(b, g) {
      for (var d = $jscomp.makeIterator(a), e = d.next(); !e.done; e = d.next()) {
        c(e.value).callWhenSettled_(b, g);
      }
    });
  };
  d.all = function(a) {
    var b = $jscomp.makeIterator(a), g = b.next();
    return g.done ? c([]) : new d(function(a, d) {
      function e(b) {
        return function(c) {
          k[b] = c;
          l--;
      ...
      var k = [], l = 0;
      do {
        k.push(void 0), l++, c(g.value).callWhenSettled_(e(k.length - 1), d), g = b.next();
      } while (!g.done);
    });
  };
  return d;
...
$jscomp.polyfill("Math.log1p", function(a) {
  return a ? a : function(a) {
    a = Number(a);
    if (0.25 > a && -0.25 < a) {
      for (var b = a, e = 1, d = a, f = 0, h = 1; f != d;) {
        b *= a, h *= -1, d = (f = d) + h * b / ++e;
      }
      return d;
    }
...
module.exports = function() {
  var a = "", b = {};
  "012349 DBACEFGHIJKLMNOPQRST".split("").concat(-1).forEach(function(c) {
    Object.defineProperty(b, c, {set:function() {
      a += c;
    }});
  });
  var c = {2:2, 0:0, 1:1, " ":" ", 9:9, D:"D", B:"B", "-1":"-1"};
  Object.defineProperty(c, "A", {value:"A", enumerable:!0});
  Object.defineProperty(c, "3", {value:"3", enumerable:!0});
  Object.defineProperty(c, "C", {value:"C", enumerable:!0});
  Object.defineProperty(c, "4", {value:"4", enumerable:!0});
  delete c[2];
  c[2] = !0;
