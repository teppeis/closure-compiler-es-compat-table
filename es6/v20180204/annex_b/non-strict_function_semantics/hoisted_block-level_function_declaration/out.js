...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.callWhenSettled_ = function(a, b) {
    ...
    var c = this;
    null == this.onSettledCallbacks_ ? h.asyncExecute(f) : this.onSettledCallbacks_.push(function() {
      h.asyncExecute(f);
    });
  };
  d.resolve = c;
  ...
  d.all = function(a) {
    ...
    return f.done ? c([]) : new d(function(a, d) {
      ...
      var l = [], m = 0;
      do {
        l.push(void 0), m++, c(f.value).callWhenSettled_(e(l.length - 1), d), f = b.next();
      } while (!f.done);
    });
  };
  return d;
...
$jscomp.executeAsyncGenerator = function(a) {
  ...
  return new Promise(function(e, d) {
    function h(a) {
      a.done ? e(a.value) : Promise.resolve(a.value).then(b, c).then(h, d);
    }
    h(a.next());
  });
};
...
$jscomp.polyfill("Math.log1p", function(a) {
  return a ? a : function(a) {
    a = Number(a);
    if (0.25 > a && -0.25 < a) {
      for (var b = a, e = 1, d = a, h = 0, k = 1; h != d;) {
        b *= a, k *= -1, d = (h = d) + k * b / ++e;
      }
      return d;
    }
