...
module.exports = function() {
  var $Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180204$built_in_extensions$function_name_property$object_methods__class_$in$classdecl$var0 = function() {
  };
  var $Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180204$built_in_extensions$function_name_property$object_methods__class_$in$classdecl$var1 = function() {
  };
  var o = {foo:$Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180204$built_in_extensions$function_name_property$object_methods__class_$in$classdecl$var0, bar:$Users$teppeis$src$github_com$teppeis$closure_compiler_es6_compat_table$es6$v20180204$built_in_extensions$function_name_property$object_methods__class_$in$classdecl$var1};
  o.qux = function() {
  };
