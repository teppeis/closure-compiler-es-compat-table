...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.then = function(a, b) {
    ...
    var c, e, k = new d(function(a, b) {
      c = a;
      e = b;
    });
    this.callWhenSettled_(g(a, c), g(b, e));
    return k;
  };
  ...
  d.prototype.callWhenSettled_ = function(a, b) {
    ...
    var c = this;
    null == this.onSettledCallbacks_ ? f.asyncExecute(g) : this.onSettledCallbacks_.push(function() {
      f.asyncExecute(g);
    });
  };
  d.resolve = c;
  ...
  d.all = function(a) {
    ...
    return g.done ? c([]) : new d(function(a, d) {
      ...
      var l = [], k = 0;
      do {
        l.push(void 0), k++, c(g.value).callWhenSettled_(e(l.length - 1), d), g = b.next();
      } while (!g.done);
    });
  };
  return d;
...
module.exports = function() {
  var a = {b:2, c:void 0, x:4}, b = void 0 === a.a ? 1 : a.a, c = void 0 === a.b ? 0 : a.b, e = void 0 === a.c ? 3 : a.c, d = void 0 === a.x ? 0 : a.x;
  a = void 0 === a.y ? 5 : a.y;
  var f = $jscomp.makeIterator([, 7, void 0]), h = f.next().value;
  h = void 0 === h ? 6 : h;
  var k = f.next().value;
  k = void 0 === k ? 0 : k;
  f = f.next().value;
  return 1 === b && 2 === c && 3 === e && 4 === d && 5 === a && 6 === h && 7 === k && 8 === (void 0 === f ? 8 : f);
};
