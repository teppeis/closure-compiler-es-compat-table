...
module.exports = function() {
  $jscomp.initSymbolIterator();
  var a = (new Set)[Symbol.iterator](), d = Object.getPrototypeOf(a), b = Object.getPrototypeOf(d);
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  return b.hasOwnProperty(Symbol.iterator) && !d.hasOwnProperty(Symbol.iterator) && !a.hasOwnProperty(Symbol.iterator) && a[Symbol.iterator]() === a;
};
