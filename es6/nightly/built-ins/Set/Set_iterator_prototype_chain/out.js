...
module.exports = function() {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  var a = (new Set)[Symbol.iterator](), e = Object.getPrototypeOf(a), c = Object.getPrototypeOf(e);
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  return c.hasOwnProperty(Symbol.iterator) && !e.hasOwnProperty(Symbol.iterator) && !a.hasOwnProperty(Symbol.iterator) && a[Symbol.iterator]() === a;
};
