...
module.exports = function() {
  $jscomp.initSymbolIterator();
  var a = (new Map)[Symbol.iterator](), b = Object.getPrototypeOf(a), d = Object.getPrototypeOf(b);
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbolIterator();
  return d.hasOwnProperty(Symbol.iterator) && !b.hasOwnProperty(Symbol.iterator) && !a.hasOwnProperty(Symbol.iterator) && a[Symbol.iterator]() === a;
};
