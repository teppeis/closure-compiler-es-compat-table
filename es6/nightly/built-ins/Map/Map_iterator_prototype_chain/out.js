...
$jscomp.polyfill("WeakMap", function(b) {
  function c() {
    ...
    try {
      var f = Object.seal({}), a = Object.seal({}), l = new b([[f, 2], [a, 3]]);
      if (2 != l.get(f) || 3 != l.get(a)) {
        return !1;
      }
      l.delete(f);
      l.set(a, 4);
      return !l.has(f) && 4 == l.get(a);
    } catch (p) {
      return !1;
    }
  }
...
module.exports = function() {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  var b = (new Map)[Symbol.iterator](), c = Object.getPrototypeOf(b), e = Object.getPrototypeOf(c);
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  return e.hasOwnProperty(Symbol.iterator) && !c.hasOwnProperty(Symbol.iterator) && !b.hasOwnProperty(Symbol.iterator) && b[Symbol.iterator]() === b;
};
