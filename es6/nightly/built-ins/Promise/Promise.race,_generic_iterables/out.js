...
$jscomp.polyfillIsolated = function(b, d, f, g) {
  ...
  d = d(f);
  null != d && (b ? $jscomp.defineProperty($jscomp.polyfills, c, {configurable:!0, writable:!0, value:d}) : d !== f && ($jscomp.propertyToPolyfillSymbol[c] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(c) : $jscomp.POLYFILL_PREFIX + c, c = $jscomp.propertyToPolyfillSymbol[c], $jscomp.defineProperty(g, c, {configurable:!0, writable:!0, value:d})));
};
...
$jscomp.polyfill("Promise", function(b) {
  ...
  if (b && !(($jscomp.FORCE_POLYFILL_PROMISE || $jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && "undefined" === typeof $jscomp.global.PromiseRejectionEvent) && $jscomp.global.Promise && $jscomp.global.Promise.toString().includes("[native code]"))) {
    return b;
  }
...
module.exports = function(b) {
  ...
  var d = Promise.race(global.__createIterableObject([new Promise(function(c) {
    setTimeout(c, 1000, "foo");
  }), new Promise(function(c, l) {
    setTimeout(l, 2000, "bar");
  }), ])), f = Promise.race(global.__createIterableObject([new Promise(function(c, l) {
    setTimeout(l, 1000, "baz");
  }), new Promise(function(c) {
    setTimeout(c, 2000, "qux");
  }), ])), g = 0;
  d.then(function(c) {
    g += "foo" === c;
    2 === g && b();
