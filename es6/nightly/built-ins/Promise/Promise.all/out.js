...
$jscomp.polyfillIsolated = function(c, e, f, h) {
  ...
  e = e(f);
  null != e && (c ? $jscomp.defineProperty($jscomp.polyfills, b, {configurable:!0, writable:!0, value:e}) : e !== f && ($jscomp.propertyToPolyfillSymbol[b] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(b) : $jscomp.POLYFILL_PREFIX + b, b = $jscomp.propertyToPolyfillSymbol[b], $jscomp.defineProperty(h, b, {configurable:!0, writable:!0, value:e})));
};
$jscomp.polyfill("Promise", function(c) {
  ...
  if (c && !(($jscomp.FORCE_POLYFILL_PROMISE || $jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && "undefined" === typeof $jscomp.global.PromiseRejectionEvent) && $jscomp.global.Promise && $jscomp.global.Promise.toString().includes("[native code]"))) {
    return c;
  }
...
module.exports = function(c) {
  var e = Promise.all([new Promise(function(b) {
    setTimeout(b, 2000, "foo");
  }), new Promise(function(b) {
    setTimeout(b, 1000, "bar");
  }), ]), f = Promise.all([new Promise(function(b, m) {
    setTimeout(m, 2000, "baz");
  }), new Promise(function(b, m) {
    setTimeout(m, 1000, "qux");
  }), ]), h = 0;
  e.then(function(b) {
    h += "foo,bar" === b + "";
    2 === h && c();
