...
module.exports = function() {
  var a = function e() {
    return $jscomp.generator.createGenerator(e, function(f) {
      return f.yieldAll(function k() {
        return $jscomp.generator.createGenerator(k, function(g) {
          return 1 == g.nextAddress ? g.yield(5, 2) : 3 != g.nextAddress ? g.yield(6, 3) : g.yield(7, 0);
        });
      }(), 0);
    });
