...
module.exports = function() {
  var a = function e() {
    return $jscomp.generator.createGenerator(e, function(a) {
      return a.yieldAll(function h() {
        return $jscomp.generator.createGenerator(h, function(a) {
          return 1 == a.nextAddress ? a.yield(5, 2) : 3 != a.nextAddress ? a.yield(6, 3) : a.yield(7, 0);
        });
      }(), 0);
    });
