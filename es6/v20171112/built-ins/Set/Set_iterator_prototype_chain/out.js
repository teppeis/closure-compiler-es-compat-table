...
module.exports = function() {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  var a = (new Set)[Symbol.iterator](), c = Object.getPrototypeOf(a), b = Object.getPrototypeOf(c);
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  return b.hasOwnProperty(Symbol.iterator) && !c.hasOwnProperty(Symbol.iterator) && !a.hasOwnProperty(Symbol.iterator) && a[Symbol.iterator]() === a;
};
