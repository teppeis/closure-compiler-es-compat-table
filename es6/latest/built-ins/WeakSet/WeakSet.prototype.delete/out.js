...
var $jscomp$lookupPolyfilledValue = function(a, c, d) {
  if (!d || null != a) {
...
$jscomp.polyfillIsolated = function(a, c, d, b) {
  ...
  c = c(d);
  null != c && (a ? $jscomp.defineProperty($jscomp.polyfills, f, {configurable:!0, writable:!0, value:c}) : c !== d && (void 0 === $jscomp.propertyToPolyfillSymbol[f] && (d = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[f] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(f) : $jscomp.POLYFILL_PREFIX + d + "$" + f), $jscomp.defineProperty(b, $jscomp.propertyToPolyfillSymbol[f], {configurable:!0, writable:!0, value:c})));
};
