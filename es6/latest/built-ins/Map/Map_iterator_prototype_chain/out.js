...
module.exports = function() {
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  var b = (new Map)[Symbol.iterator](), c = Object.getPrototypeOf(b), f = Object.getPrototypeOf(c);
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  return f.hasOwnProperty(Symbol.iterator) && !c.hasOwnProperty(Symbol.iterator) && !b.hasOwnProperty(Symbol.iterator) && b[Symbol.iterator]() === b;
};
