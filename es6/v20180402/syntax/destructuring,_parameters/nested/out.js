...
module.exports = function() {
  return function($jscomp$destructuring$var0, $jscomp$destructuring$var1) {
    var $jscomp$destructuring$var2 = $jscomp.makeIterator($jscomp$destructuring$var0);
    var e = $jscomp$destructuring$var2.next().value;
    var $jscomp$destructuring$var3 = $jscomp$destructuring$var2.next().value;
    var f = $jscomp$destructuring$var3.x;
    var g = $jscomp$destructuring$var3.g;
    var $jscomp$destructuring$var4 = $jscomp$destructuring$var1;
    var h = $jscomp$destructuring$var4.h;
    var $jscomp$destructuring$var5 = $jscomp.makeIterator($jscomp$destructuring$var4.x);
    var i = $jscomp$destructuring$var5.next().value;
