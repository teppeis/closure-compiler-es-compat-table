...
module.exports = function() {
  return function($jscomp$destructuring$var0, $jscomp$destructuring$var1) {
    ...
    var a = $jscomp$destructuring$var2.next().value;
    var b = $jscomp.arrayFromIterator($jscomp$destructuring$var2);
    var $jscomp$destructuring$var3 = $jscomp.makeIterator($jscomp$destructuring$var1);
    var c = $jscomp$destructuring$var3.next().value;
    var d = $jscomp.arrayFromIterator($jscomp$destructuring$var3);
