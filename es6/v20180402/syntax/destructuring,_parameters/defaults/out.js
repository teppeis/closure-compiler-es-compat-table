...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.then = function(a, b) {
    ...
    var e, m, k = new d(function(a, b) {
      e = a;
      m = b;
    });
    this.callWhenSettled_(c(a, e), c(b, m));
    return k;
  };
  ...
  d.all = function(a) {
    ...
    return h.done ? c([]) : new d(function(a, d) {
      ...
      var l = [], m = 0;
      do {
        l.push(void 0), m++, c(h.value).callWhenSettled_(e(l.length - 1), d), h = b.next();
      } while (!h.done);
    });
  };
  return d;
...
module.exports = function() {
  ...
  a = void 0 === a.y ? 5 : a.y;
  var f = $jscomp.makeIterator([, 7, void 0]), g = f.next().value;
  g = void 0 === g ? 6 : g;
  var k = f.next().value;
  k = void 0 === k ? 0 : k;
  f = f.next().value;
  return 1 === b && 2 === c && 3 === e && 4 === d && 5 === a && 6 === g && 7 === k && 8 === (void 0 === f ? 8 : f);
};
