...
module.exports = function() {
  ...
  var $jscomp$destructuring$var0 = $jscomp.makeIterator(a);
  first = $jscomp$destructuring$var0.next().value;
  var $jscomp$destructuring$var1 = $jscomp.makeIterator($jscomp.arrayFromIterator($jscomp$destructuring$var0));
  a[2] = $jscomp$destructuring$var1.next().value;
  last = $jscomp$destructuring$var1.next().value;
