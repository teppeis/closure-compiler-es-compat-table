...
module.exports = function() {
  for (var $jscomp$iter$0 = $jscomp.makeIterator([[1, 2, 3]]), $jscomp$key$$jscomp$destructuring$var0 = $jscomp$iter$0.next(); !$jscomp$key$$jscomp$destructuring$var0.done; $jscomp$key$$jscomp$destructuring$var0 = $jscomp$iter$0.next()) {
    var $jscomp$destructuring$var0 = $jscomp$key$$jscomp$destructuring$var0.value;
    {
      ...
      var i = $jscomp$destructuring$var1.next().value;
      var j = $jscomp$destructuring$var1.next().value;
      var k = $jscomp$destructuring$var1.next().value;
      return i === 1 && j === 2 && k === 3;
    }
  }
};
