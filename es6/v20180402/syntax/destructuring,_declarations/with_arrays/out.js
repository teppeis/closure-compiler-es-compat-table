...
module.exports = function() {
  var $jscomp$destructuring$var0 = $jscomp.makeIterator([5, null, [6]]);
  var a = $jscomp$destructuring$var0.next().value;
  $jscomp$destructuring$var0.next();
  var $jscomp$destructuring$var1 = $jscomp.makeIterator($jscomp$destructuring$var0.next().value);
