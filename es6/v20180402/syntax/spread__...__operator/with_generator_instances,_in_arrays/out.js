    ...
    return $jscomp.generator.createGenerator($jscomp$generator$function, function($jscomp$generator$context) {
      do {
        switch($jscomp$generator$context.nextAddress) {
          case 1:
            return $jscomp$generator$context.yield("b", 2);
          case 2:
            return $jscomp$generator$context.yield("c", 3);
          case 3:
            return $jscomp$generator$context.yield("d", 0);
        }
      } while (0);
    });
  }();
  return ["a"].concat($jscomp.arrayFromIterable(iterable), ["e"])[3] === "d";
};
