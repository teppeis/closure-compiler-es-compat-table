...
module.exports = function() {
  ...
  for (var $jscomp$iter$0 = $jscomp.makeIterator(iter), $jscomp$key$it = $jscomp$iter$0.next(); !$jscomp$key$it.done; $jscomp$key$it = $jscomp$iter$0.next()) {
    var it = $jscomp$key$it.value;
    {
      break;
    }
  }
