...
module.exports = function() {
  var result = "";
  var iterable = function $jscomp$generator$function() {
    return $jscomp.generator.createGenerator($jscomp$generator$function, function($jscomp$generator$context) {
      do {
        switch($jscomp$generator$context.nextAddress) {
          ...
          case 2:
            return $jscomp$generator$context.yield(2, 3);
          case 3:
  ...
  for (var $jscomp$iter$0 = $jscomp.makeIterator(iterable), $jscomp$key$item = $jscomp$iter$0.next(); !$jscomp$key$item.done; $jscomp$key$item = $jscomp$iter$0.next()) {
