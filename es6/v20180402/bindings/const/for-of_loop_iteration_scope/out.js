...
module.exports = function() {
  var scopes = [];
  var $jscomp$loop$1 = {};
  var $jscomp$iter$0 = $jscomp.makeIterator(["a", "b"]), $jscomp$key$i = $jscomp$iter$0.next();
  for (; !$jscomp$key$i.done; $jscomp$loop$1 = {i:$jscomp$loop$1.i}, $jscomp$key$i = $jscomp$iter$0.next()) {
    $jscomp$loop$1.i = $jscomp$key$i.value;
    {
