...
module.exports = function() {
  function generatorFn() {
    return $jscomp.generator.createGenerator(generatorFn, function($jscomp$generator$context) {
      do {
  ...
  $jscomp.initSymbol();
  $jscomp.initSymbolIterator();
  passed &= iterProto.hasOwnProperty(Symbol.iterator) && !sharedProto.hasOwnProperty(Symbol.iterator) && !ownProto.hasOwnProperty(Symbol.iterator) && g[Symbol.iterator]() === g;
  return passed;
};
