...
module.exports = function() {
  $jscomp.initSymbolIterator();
  var closed = false;
  var iter = global.__createIterableObject([1, 2, 3], {"throw":undefined, "return":function() {
    closed = true;
    return {done:true};
  }});
  var gen = function $jscomp$generator$function() {
    var e;
      ...
      do {
        switch($jscomp$generator$context.nextAddress) {
          case 1:
            ...
            return $jscomp$generator$context.yieldAll(iter, 4);
          case 4:
