...
$jscomp.polyfill("Reflect.defineProperty", function(a) {
  return a ? a : function(a, c, e) {
    try {
      ...
      return b ? b.configurable === (e.configurable || !1) && b.enumerable === (e.enumerable || !1) && ("value" in b ? b.value === e.value && b.writable === (e.writable || !1) : b.get === e.get && b.set === e.set) : !1;
    } catch (f) {
      return !1;
    }
  };
...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.race = function(a) {
    return new d(function(b, d) {
      for (var e = $jscomp.makeIterator(a), h = e.next(); !h.done; h = e.next()) {
        c(h.value).callWhenSettled_(b, d);
      }
    });
  };
  d.all = function(a) {
