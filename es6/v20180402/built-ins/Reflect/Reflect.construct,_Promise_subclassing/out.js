...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.callWhenSettled_ = function(a, b) {
    ...
    var c = this;
    null == this.onSettledCallbacks_ ? g.asyncExecute(f) : this.onSettledCallbacks_.push(f);
  };
  d.resolve = c;
  d.reject = function(a) {
...
module.exports = function(a) {
  ...
  var d = Reflect.construct(Promise, [function(a, b) {
    a("foo");
  }], b), g = Reflect.construct(Promise, [function(a, b) {
    b("quux");
  }], b), h = +(d instanceof b && g instanceof b);
  d.then = g.then = Promise.prototype.then;
  d.catch = g.catch = Promise.prototype.catch;
  d.then(function(b) {
    h += "foo" === b;
    4 === h && a();
  }, e);
