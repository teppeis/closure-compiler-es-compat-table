...
$jscomp.polyfillIsolated = function(a, b, d, g) {
  ...
  b = b(d);
  null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, e, {configurable:!0, writable:!0, value:b}) : b !== d && (void 0 === $jscomp.propertyToPolyfillSymbol[e] && (d = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[e] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(e) : $jscomp.POLYFILL_PREFIX + d + "$" + e), $jscomp.defineProperty(g, $jscomp.propertyToPolyfillSymbol[e], {configurable:!0, writable:!0, value:b})));
};
...
$jscomp.polyfill("Symbol", function(a) {
  ...
  var d = "jscomp_symbol_" + (1E9 * Math.random() >>> 0) + "_", g = 0, e = function(l) {
    if (this instanceof e) {
      throw new TypeError("Symbol is not a constructor");
    }
    return new b(d + (l || "") + "_" + g++, l);
  };
  return e;
}, "es6", "es3");
...
$jscomp.polyfill("Promise", function(a) {
  ...
  e.prototype.then = function(c, f) {
    ...
    var m, k, t = new e(function(n, p) {
      m = n;
      k = p;
    });
    this.callWhenSettled_(h(c, m), h(f, k));
    return t;
  };
  ...
  e.race = function(c) {
    return new e(function(f, h) {
      for (var m = $jscomp.makeIterator(c), k = m.next(); !k.done; k = m.next()) {
        d(k.value).callWhenSettled_(f, h);
      }
    });
  };
  e.all = function(c) {
    var f = $jscomp.makeIterator(c), h = f.next();
    return h.done ? d([]) : new e(function(m, k) {
      function t(q) {
        return function(r) {
          n[q] = r;
          p--;
      ...
      var n = [], p = 0;
      do {
        n.push(void 0), p++, d(h.value).callWhenSettled_(t(n.length - 1), k), h = f.next();
      } while (!h.done);
    });
  };
  return e;
  ...
  (function(d) {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(k) {
      switch(k.nextAddress) {
        case 1:
          g = [], k.setCatchFinallyBlocks(2, 3), f = $jscomp.makeAsyncIterator(d);
        case 5:
          return k.yield(f.next(), 8);
        case 8:
          l = k.yieldResult;
          if (l.done) {
            k.jumpTo(3);
        ...
        case 3:
          k.enterFinallyBlock();
          k.setFinallyBlock(9);
          if (!l || l.done || !(c = f.return)) {
            k.jumpTo(9);
            break;
          }
          return k.yield(c.call(f), 9);
        case 9:
          k.enterFinallyBlock(0, 0, 1);
          if (e) {
            throw e.error;
          }
          k.leaveFinallyBlock(10, 1);
          break;
        case 10:
          k.leaveFinallyBlock(4);
          break;
        case 2:
          m = k.enterCatchBlock();
          e = {error:m};
