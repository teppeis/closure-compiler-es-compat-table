...
$jscomp.polyfillIsolated = function(a, b, d, f) {
  ...
  b = b(d);
  null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, e, {configurable:!0, writable:!0, value:b}) : b !== d && (void 0 === $jscomp.propertyToPolyfillSymbol[e] && (d = 1e9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[e] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(e) : $jscomp.POLYFILL_PREFIX + d + "$" + e), e = $jscomp.propertyToPolyfillSymbol[e], $jscomp.defineProperty(f, e, {configurable:!0, writable:!0, value:b})));
};
...
$jscomp.asyncExecutePromiseGenerator = function(a) {
  ...
  return new Promise(function(f, e) {
    function k(c) {
      c.done ? f(c.value) : Promise.resolve(c.value).then(b, d).then(k, e);
    }
    k(a.next());
  });
};
...
$jscomp.polyfill("Symbol", function(a) {
  ...
  var d = "jscomp_symbol_" + (1e9 * Math.random() >>> 0) + "_", f = 0, e = function(k) {
...
$jscomp.AsyncGeneratorWrapper.prototype.enqueueMethod_ = function(a, b) {
  var d = this;
  return new Promise(function(f, e) {
    var k = d.executionQueue_.isEmpty();
...
module.exports = function(a) {
  var b = AsyncIterator.from(function() {
    return new $jscomp.AsyncGeneratorWrapper(function f() {
      return $jscomp.generator.createGenerator(f, function(e) {
  ...
  (function(d) {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(g) {
      switch(g.nextAddress) {
        case 1:
          f = [], e = $jscomp.makeAsyncIterator(d);
        case 2:
          return g.yield(e.next(), 5);
        case 5:
          k = g.yieldResult;
          if (k.done) {
            g.jumpTo(4);
