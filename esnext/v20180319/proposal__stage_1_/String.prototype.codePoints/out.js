...
module.exports = function() {
  var results = [];
  for (var $jscomp$iter$0 = $jscomp.makeIterator("a\ud842\udfb7b".codePoints()), $jscomp$key$code = $jscomp$iter$0.next(); !$jscomp$key$code.done; $jscomp$key$code = $jscomp$iter$0.next()) {
    var code = $jscomp$key$code.value;
    {
      results.push(code);
    }
  }
  return results.length === 3 && results[0] === 97 && results[1] === 134071 && results[2] === 98;
};
