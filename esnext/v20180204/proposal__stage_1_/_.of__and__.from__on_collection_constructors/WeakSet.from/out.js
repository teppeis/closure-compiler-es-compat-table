...
$jscomp.polyfill("WeakSet", function(a) {
  function b() {
    ...
    try {
      var b = Object.seal({}), c = Object.seal({}), f = new a([b]);
      if (!f.has(b) || f.has(c)) {
        return !1;
      }
      f.delete(b);
      f.add(c);
      return !f.has(b) && f.has(c);
    } catch (h) {
      return !1;
    }
  }
...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.race = function(a) {
    return new d(function(b, d) {
      for (var g = $jscomp.makeIterator(a), e = g.next(); !e.done; e = g.next()) {
