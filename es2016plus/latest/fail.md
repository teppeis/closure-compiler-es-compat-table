...
### JSON superset
- LINE SEPARATOR can appear in string literals ([in](https://github.com/teppeis/closure-compiler-es6-compat-table/blob/master/es2016plus/latest/2019_misc/JSON_superset/LINE_SEPARATOR_can_appear_in_string_literals/in.js)/[out](https://github.com/teppeis/closure-compiler-es6-compat-table/blob/master/es2016plus/latest/2019_misc/JSON_superset/LINE_SEPARATOR_can_appear_in_string_literals/out.js))
- PARAGRAPH SEPARATOR can appear in string literals ([in](https://github.com/teppeis/closure-compiler-es6-compat-table/blob/master/es2016plus/latest/2019_misc/JSON_superset/PARAGRAPH_SEPARATOR_can_appear_in_string_literals/in.js)/[out](https://github.com/teppeis/closure-compiler-es6-compat-table/blob/master/es2016plus/latest/2019_misc/JSON_superset/PARAGRAPH_SEPARATOR_can_appear_in_string_literals/out.js))
