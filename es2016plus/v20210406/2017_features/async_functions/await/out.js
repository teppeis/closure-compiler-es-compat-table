...
$jscomp.polyfillIsolated = function(a, b, e, f) {
  ...
  b = b(e);
  null != b && (a ? $jscomp.defineProperty($jscomp.polyfills, d, {configurable:!0, writable:!0, value:b}) : b !== e && (void 0 === $jscomp.propertyToPolyfillSymbol[d] && ($jscomp.propertyToPolyfillSymbol[d] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(d) : $jscomp.POLYFILL_PREFIX + d), $jscomp.defineProperty(f, $jscomp.propertyToPolyfillSymbol[d], {configurable:!0, writable:!0, value:b})));
};
...
$jscomp.asyncExecutePromiseGenerator = function(a) {
  ...
  return new Promise(function(f, d) {
    function l(c) {
      c.done ? f(c.value) : Promise.resolve(c.value).then(b, e).then(l, d);
    }
    l(a.next());
  });
};
  ...
  (function() {
    ...
    return $jscomp.asyncExecutePromiseGeneratorProgram(function(f) {
      switch(f.nextAddress) {
        case 1:
          return f.yield(Promise.resolve(), 2);
        case 2:
          return f.yield(new Promise(function(d) {
            setTimeout(d, 800, "foo");
          }), 3);
        case 3:
          return b = f.yieldResult, f.yield(new Promise(function(d) {
            setTimeout(d, 800, "bar");
          }), 4);
        case 4:
          e = f.yieldResult, "foobar" === b + e && a(), f.jumpToEnd();
      }
    });
  })();
};
