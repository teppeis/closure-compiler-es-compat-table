...
module.exports = function() {
  function generator() {
    return $jscomp.generator.createGenerator(generator, function($jscomp$generator$context) {
      do {
        switch($jscomp$generator$context.nextAddress) {
          case 1:
            return $jscomp$generator$context.yieldAll(function $jscomp$generator$function$1() {
              var e;
              return $jscomp.generator.createGenerator($jscomp$generator$function$1, function($jscomp$generator$context$1) {
                do {
                  switch($jscomp$generator$context$1.nextAddress) {
                    case 1:
                      $jscomp$generator$context$1.setCatchFinallyBlocks(2);
                      return $jscomp$generator$context$1.yield("foo", 4);
                    case 4:
                      $jscomp$generator$context$1.leaveTryBlock(0);
                      break;
                    case 2:
                      e = $jscomp$generator$context$1.enterCatchBlock();
          ...
          case 2:
            return $jscomp$generator$context.yield("bar", 0);
        }
      } while (0);
    });
  }
