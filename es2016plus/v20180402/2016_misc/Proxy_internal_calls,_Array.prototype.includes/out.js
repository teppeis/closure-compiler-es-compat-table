...
module.exports = function() {
  var a = [], b = new Proxy({length:3, 0:"", 1:"", 2:"", 3:""}, {get:function(b, e) {
    a.push(e);
    return b[e];
  }});
  Array.prototype.includes.call(b, {});
  if ("length,0,1,2" === a + "") {
    return a = [], b = new Proxy({length:4, 0:NaN, 1:"", 2:NaN, 3:""}, {get:function(b, e) {
      a.push(e);
      return b[e];
    }}), Array.prototype.includes.call(b, NaN, 1), "length,1,2" === a + "";
  }
};
