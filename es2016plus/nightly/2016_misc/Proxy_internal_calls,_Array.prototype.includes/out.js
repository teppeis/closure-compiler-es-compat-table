...
$jscomp.polyfillIsolated = function(b, c, a, d) {
  ...
  c = c(a);
  null != c && (b ? $jscomp.defineProperty($jscomp.polyfills, e, {configurable:!0, writable:!0, value:c}) : c !== a && (void 0 === $jscomp.propertyToPolyfillSymbol[e] && (a = 1e9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[e] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(e) : $jscomp.POLYFILL_PREFIX + a + "$" + e), e = $jscomp.propertyToPolyfillSymbol[e], $jscomp.defineProperty(d, e, {configurable:!0, writable:!0, value:c})));
};
...
module.exports = function() {
  var b = [], c = new Proxy({length:3, 0:"", 1:"", 2:"", 3:""}, {get:function(a, d) {
    b.push(d);
    return a[d];
  }});
  Array.prototype.includes.call(c, {});
  if ("length,0,1,2" === b + "") {
    return b = [], c = new Proxy({length:4, 0:NaN, 1:"", 2:NaN, 3:""}, {get:function(a, d) {
      b.push(d);
      return a[d];
    }}), Array.prototype.includes.call(c, NaN, 1), "length,1,2" === b + "";
  }
};
