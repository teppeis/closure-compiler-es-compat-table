...
module.exports = function() {
  function a() {
    return $jscomp.generator.createGenerator(a, function(c) {
      return 1 == c.nextAddress ? c.yieldAll(function e() {
        return $jscomp.generator.createGenerator(e, function(f) {
          if (1 == f.nextAddress) {
            return f.setCatchFinallyBlocks(2), f.yield("foo", 4);
          }
          if (2 != f.nextAddress) {
            return f.leaveTryBlock(0);
          }
          f.enterCatchBlock();
          return f.return();
        });
