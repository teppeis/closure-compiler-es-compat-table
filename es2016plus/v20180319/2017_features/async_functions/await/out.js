      ...
      return $jscomp.generator.createGenerator($jscomp$generator$function, function($jscomp$generator$context) {
        do {
          switch($jscomp$generator$context.nextAddress) {
            case 1:
              return $jscomp$generator$context.yield(Promise.resolve(), 2);
            case 2:
              return $jscomp$generator$context.yield(new Promise(function(resolve) {
                setTimeout(resolve, 800, "foo");
              }), 3);
            case 3:
              a1 = $jscomp$generator$context.yieldResult;
              return $jscomp$generator$context.yield(new Promise(function(resolve) {
                setTimeout(resolve, 800, "bar");
              }), 4);
            case 4:
              a2 = $jscomp$generator$context.yieldResult;
              if (a1 + a2 === "foobar") {
                asyncTestPassed();
              }
