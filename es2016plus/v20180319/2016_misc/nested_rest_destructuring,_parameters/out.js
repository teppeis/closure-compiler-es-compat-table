...
module.exports = function() {
  return function($jscomp$destructuring$var0) {
    ...
    var $jscomp$destructuring$var2 = $jscomp.makeIterator($jscomp.arrayFromIterator($jscomp$destructuring$var1));
    var y = $jscomp$destructuring$var2.next().value;
    var z = $jscomp.arrayFromIterator($jscomp$destructuring$var2);
