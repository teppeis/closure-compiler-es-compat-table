...
module.exports = function() {
  ...
  (function a(b) {
    ...
    if (b === undefined) {
      ...
      var $jscomp$generator$next$arg1 = $jscomp$generator$next$arg;
      JSCompiler_temp$jscomp$0 = $jscomp$generator$next$arg1;
    } else {
      JSCompiler_temp$jscomp$0 = b;
    }
    b = JSCompiler_temp$jscomp$0;
    function $jscomp$async$generator() {
      var $jscomp$generator$state = 0;
      function $jscomp$generator$impl($jscomp$generator$action$arg, $jscomp$generator$next$arg, $jscomp$generator$throw$arg) {
        while (1) {
