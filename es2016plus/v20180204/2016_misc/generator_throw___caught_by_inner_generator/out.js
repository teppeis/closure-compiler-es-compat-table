...
$jscomp.polyfill("Promise", function(a) {
  ...
  d.prototype.then = function(a, b) {
    ...
    var e, k, n = new d(function(a, b) {
      e = a;
      k = b;
    });
    this.callWhenSettled_(c(a, e), c(b, k));
    return n;
  };
...
$jscomp.polyfill("Map", function(a) {
  ...
  var d = function(a, b) {
    var d = b && typeof b;
    "object" == d || "function" == d ? c.has(b) ? d = c.get(b) : (d = "" + ++n, c.set(b, d)) : d = "p_" + b;
    var e = a.data_[d];
  ...
  var a = function() {
    function a(a, b, f) {
      for (;;) {
        switch(c) {
          case 0:
            d = $jscomp.makeIterator(function() {
              function a(a, c, d) {
                for (;;) {
                  switch(b) {
                    case 0:
